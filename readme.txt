=== Plugin Name ===
Name: Children Content Shortcode Plugin
Contributors: MyWebsiteAdvisor, ChrisHurst
Tags: children, content, shortcode, plugin
...
1. Upload `children-content/` to the `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. use the [children-content] shortcode where you want to display the content of the child pages.
...
1. example output of the plugin shortcode.
